...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-jmqul7g.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-jmqul7g.containers.anotherwebservice.com/
...
```
git clone git@github.com:xmanindia/container-jmqul7g.git
cd container-jmqul7g
```
...
```
docker attach container-jmqul7g
```
